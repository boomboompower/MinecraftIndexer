...
public class BetterJsonObject {
    ...
    /**
     * Extremely complex algorithms to load the json from a file
     *
     * @param fileIn file to load json from
     */
    public BetterJsonObject(File fileIn) {
        ...
        try {
            ...
            this.data = new JsonParser().parse(builder.toString().trim()).getAsJsonObject();
